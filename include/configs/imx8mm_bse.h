...
#endif /* end of CONFIG_SECURE_BOOT */
...
#endif /* end of if defined(CONFIG_CMD_NET) */
...
#define JAILHOUSE_ENV \
	"jh_clk= \0 " \
	"jh_mmcboot=mw 0x303d0518 0xff; setenv fdt_file fsl-imx8mm-bse-root.dtb;" \
		"setenv jh_clk clk_ignore_unused; " \
			   "if run loadimage; then " \
				   "run mmcboot; " \
			   "else run jh_netboot; fi; \0" \
	"jh_netboot=mw 0x303d0518 0xff; setenv fdt_file fsl-imx8mm-bse-root.dtb; setenv jh_clk clk_ignore_unused; run netboot; \0 "
...
#endif /* end of CONFIG_ENV_OFFSET */

#ifndef CONFIG_ENV_SIZE
#define CONFIG_ENV_SIZE             (32 * SZ_1K)      /* 32K */
#endif /* end of CONFIG_ENV_SIZE */
